...
function NoSideBar(props) {
  const pageTitle = props.match.params.grid;
  const type = "boxed";
  const title = {
    boxed: pageTitle,
  ...
  return (
    <>
      <Helmet>
        <title>Lookaxa - eCommerce Website | Shop No Sidebar</title>
      </Helmet>

      <h1 className="d-none">Lookaxa - eCommerce Website - Shop No Sidebar</h1>
